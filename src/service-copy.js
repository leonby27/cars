...
export const SERVICE_PROOF = Object.freeze([
  ...
  { title: "Проверка до оплаты", text: "Сверяем продавца, цену и VIN" },
  { title: "Независимая диагностика", text: "Осмотр кузова и техники" },
...
export const ABOUT_PRINCIPLES = Object.freeze([
  { title: "Независимая проверка", text: "Кузов, технику и батарею проверяют до оплаты — объясняем результаты и помогаем оценить риски" },
  { title: "Статус на каждом этапе", text: "Статус сообщают на ключевых этапах пути до Минска" },
]);
