...
export const BLOG_FIGURES = Object.freeze({
  ...
  "quota-end": () =>
    barsFigure({
      title: "Электромобиль за 25 000 $: по квоте и без неё",
      unit: "$",
      items: [
        { label: "Цена машины в Китае", value: 25000, note: "для примера взята машина за 25 000 $" },
        { label: "Под ключ по льготной квоте", value: 30500, tone: "good", note: "пошлины нет, НДС по ставке 0% для машин моложе пяти лет" },
        { label: "Под ключ после исчерпания квоты", value: 35100, tone: "warn", note: "добавляется пошлина 15% от таможенной стоимости" },
      ],
      caption: "Пример расчёта abcars.by. Доставка и оформление в обоих случаях одинаковые, разница — только в пошлине.",
    }),
  // Утилизационный сбор для физлица: было и стало после постановления № 195.
  "util-fee": () =>
    barsFigure({
      title: "Утильсбор для физлица: было и стало",
      unit: "руб.",
      items: [
        { label: "Машина до 3 лет, было", value: 544.5, text: "544,50", note: "ставка до конца апреля 2026 года" },
        { label: "Машина до 3 лет, стало", value: 624.92, text: "624,92", tone: "warn", note: "плюс пятнадцать процентов" },
        { label: "Старше 3 лет, было", value: 1089, text: "1 089,00", note: "ставка до конца апреля 2026 года" },
        { label: "Старше 3 лет, стало", value: 1282.02, text: "1 282,02", tone: "warn", note: "ставка для машины старше трёх лет вдвое выше" },
      ],
      caption: "Льготная ставка для физического лица, ввозящего машину для себя. По постановлению Совета Министров № 195.",
    }),
});
