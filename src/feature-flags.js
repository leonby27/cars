...
const FLAGS = Object.freeze({
  ...
  REVIEWS_ENABLED: { production: false, local: true },
  ...
  // существует: ни в списке, ни на главной, ни в боковом меню, ни в карте сайта,
  // а сама страница закрыта от индексации.
  BLOG_DRAFTS_VISIBLE: { production: false, local: true },
});
...
/** Пустая страница отзывов доступна локально до наполнения раздела. */
