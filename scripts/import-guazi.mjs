...
const REPORT_PATH = path.join(RUNTIME_DIR, "import-report.json");
...
const commonHeaders = { accept: "text/plain,text/markdown,text/html;q=0.9,*/*;q=0.5", "user-agent": "abcars.by-Importer/0.1" };
