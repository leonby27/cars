...
const PATHWAYS = {
  ...
  "/ev-quota/": {
    ...
    intro: "Квота распространяется только на электромобили. Их цены уже посчитаны до Минска по текущему таможенному режиму. Рядом — бензиновые машины: на них квота не влияла, и её состояние их цену не меняет.",
