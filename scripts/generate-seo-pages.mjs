...
const publicPages = [
  ...
  { route: "/how-it-works/", title: "Как купить автомобиль из Китая в Беларуси | evcars.by", description: "Проверка объявления и автомобиля, договор, оплата, выкуп, доставка и выдача автомобиля из Китая в Минске.", h1: "Как купить автомобиль из Китая", lead: "Сначала подтверждаем наличие, состояние и полную смету. После согласования заключаем договор, выкупаем автомобиль и доставляем его в Минск." },
...
function navigation() {
  return `<header class="site-header"><nav class="page-width" aria-label="Основная навигация">
    ...
    <a href="${hrefRoute("/how-it-works/")}">Как это работает</a>
    <a href="${hrefRoute("/about/")}">О компании</a>
