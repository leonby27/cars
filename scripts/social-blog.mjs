// Ручной аварийный способ отправить материалы журнала напрямую.
// Основной плановый путь — общий недельный пакет scripts/social-week-prepare.mjs,
// поэтому этот файл нельзя добавлять в расписание одновременно с ним.
//
