...
// Вид материала на отбор не влияет: какой формат окажется наверху — дело выпуска,
// а не правила. Проверка на обязательное сравнение в четвёрке стояла здесь до
// 07.09.2026 и упала, как только вышли четыре статьи подряд: она описывала не правило,
// а случайное состояние журнала на день, когда была написана.
